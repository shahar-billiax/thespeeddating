...
export default async function SuccessStoriesPage() {
  ...
  return (
    <div>
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-primary via-primary/90 to-pink-500 py-20 sm:py-28 overflow-hidden">
        ...
        <div className="section-container relative">
          <div className="text-center text-white space-y-6 max-w-3xl mx-auto">
            <div className="h-16 w-16 mx-auto rounded-2xl bg-white/15 flex items-center justify-center">
              <Heart className="h-9 w-9 text-white fill-white/30" />
            </div>
                  ...
                  <div className="flex items-center justify-center gap-8 pt-4">
                    {heroStats.map((stat, i) => (
                      <div key={i} className="flex items-center gap-8">
                        {i > 0 && <div className="w-px h-12 bg-white/25" />}
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {featured.map((story) => (
                  <Card
                    key={story.id}
                    className="relative overflow-hidden border-0 shadow-sm bg-gradient-to-br from-primary/5 to-background"
                  >
                    <CardContent className="pt-8 pb-6 px-8">
                      <div className="h-10 w-10 rounded-xl bg-pink-100 dark:bg-pink-950 flex items-center justify-center mb-4">
                        <Quote className="h-5 w-5 text-pink-400 dark:text-pink-600" />
                      </div>
