      ...
      <section className="page-hero">
        <div className="section-container">
          <div className="text-center space-y-4 max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold">{t("blog.title")}</h1>
          </div>
        </div>
      </section>
          ...
          {posts.length === 0 ? (
            ...
            <>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                {posts.map((post) => (
                  <Card key={post.id} className="border-0 shadow-sm hover:shadow-md transition-shadow overflow-hidden flex flex-col">
                    {post.featured_image && (
